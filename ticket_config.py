...
bot = telebot.TeleBot('5501937583:AAG1uraUOUtWyxhPe1VYkq59Dht_Wx59ZSo') # Токен бота воркеров

admin = 280783837 # ID Админа
support =  280783837 # ID сапорта
channel_id = -1001524353604 # ID Канала залётов
chat_worker_id = -1001695593688 # ID Чата с воркерами

bot_name = 'bestcasino999bot' # Username Бота

mater = '-1001335336786' # Ссылка на мануалы
zalet = '-1001279993085' # Ссылка на канал с залётами
infos = '-1001365860138' # Ссылка на инфо канал
pname = 'Casino999' # Название проекта
pdate = '03.08.2022' # Дата созданя проекта
